                ...
                <main class="col-md-8 main-content">
                    <article class="post">
                        ...
                        <section class="post-content">
                            ...
                            <p>
                                敲出来的代码，思路不清晰时，可以在firebug,chrome里边打个断点跟一下，理理思路，理解代码的逻辑，这样影响才会深刻。初学者没办法都是这样，也只能这样。但是初期可能稍为慢一点，但一直不会这么慢，也不</p>
                            <p>会想象的那么长，因为随着基本概念的掌握，编码技巧的熟悉，开发工具的熟练，消化视频的速度会越来越快。</p>
                            <p>3. 等这些消化之后，阅读其它js书籍建议如下：</p>
                            <p>js dom编程艺术(2 version)->js高级程序设计 (3 version)-> js dom高级程序设计 -> js 语言精粹 -> 精通js -> 编写可维护的js
                                -> 高性能js -> js面向对象编程指南 -> js模式 -> js权威指南(6 version) -> js语言精髓与编程实践</p>
                            ...
                            <h2>4. 编辑器推荐：</h2>
                            <p>a.新手： sublime-text, <a href="http://github.com/jikeytang/sublime-text">http://github.com/jikeytang/sublime-text</a>
                            </p>
                            <p>b.熟手： webstorm: <a
                                    href="http://note.youdao.com/share/?id=2d7ff03aeca64808fdc0f394ffb520bf&type=notebook">http://note.youdao.com/share/?id=2d7ff03aeca64808fdc0f394ffb520bf&type=notebook</a>
                            </p>
                            <p>推荐这两个的原因在于，有个技术叫emmet, http://docs.emmet.io，而这两个对他的支持是：</p>
                            <p>sublime text 是所有编辑器里边支持emmet比较好的的唯一一款。</p>
                            <p>webstorm(jetbrains系列产品，intellij idea, phpstorm,
                                pycharm)是所有编辑器里边唯一内置emmet的一款，并且把emmet精神在往前推了一步的一款。</p>
